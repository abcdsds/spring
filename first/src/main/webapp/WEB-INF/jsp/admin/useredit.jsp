				...
				<div class="col-md-3">
					<div class="list-group">
						<a href="index.html" class="list-group-item active main-color-bg">
							<span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
							Dashboard
						</a> <a href="pages.html" class="list-group-item"><span
							class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>
							Pages <span class="badge">12</span></a> <a href="posts.html"
							class="list-group-item"><span
							class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
							Posts <span class="badge">33</span></a> <a href="users.html"
							class="list-group-item"><span
				...
				<div class="col-md-9">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form id="user" action="<c:url value='/useredit.do' />">
								<div class="form-group">
									<label>아이디</label> <input type="text" class="form-control"
										placeholder="아이디" id="user_id" name="user_id" value="${map.MEM_ID}" readonly>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>닉네임</label> <input type="text" name="nickname" id="nickname"
										...
										value="${map.MEM_NICKNAME}">
								</div>
								<div class="form-group">
									<label>이메일</label> <input type="text" id="email"
										class="form-control" placeholder="이메일" name="email" value="${map.MEM_EMAIL}">
								</div>
								<div class="form-group">
									<label>가입일</label> <input type="text" class="form-control"
										placeholder="가입일" value="${map.MEM_REGDATE}" readonly>
								</div>
								<div class="form-group">
									<label>회원등급</label> <select class="form-control" id="level" name="level">
										<option value="0"
											<c:if test="${map.MEM_LEVEL == 0}">selected</c:if>>운영자</option>
										<option value="1"
											<c:if test="${map.MEM_LEVEL == 1}">selected</c:if>>특별회원</option>
										<option value="2"
											<c:if test="${map.MEM_LEVEL == 2}">selected</c:if>>일반회원</option>
									</select>
								</div>
								<div class="form-group">
									<label>소셜타입</label> <input type="text" class="form-control"
										placeholder="소셜타입" value="${map.MEM_STYPE}" readonly>
								</div>
								<div class="form-group">
									<label>소셜번호</label> <input type="text" class="form-control"
										placeholder="소셜번호" value="${map.MEM_SNUM}" readonly>
								</div>
